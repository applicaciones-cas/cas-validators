 ...
 */
public class Validator_PO_Quotation_Master implements ValidatorInterface {
    GRider poGRider;
    String psMessage;
    
    Model_PO_Quotation_Master poEntity;
    
    public Validator_PO_Quotation_Master(Object foValue){
        poEntity = (Model_PO_Quotation_Master) foValue;
    }
